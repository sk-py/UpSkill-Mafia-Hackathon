...
const Header = ({ link }) => {
  return (
    <div className="bg-gray-200 dark:bg-gray-800 sticky top-0 left-0 z-10 lg:hidden ">
      <div className="container flex items-center px-6 py-4 mx-auto overflow-x-auto whitespace-nowrap">
        ...
        <Link
          href="/events"
          className="flex items-center text-blue-500 fill-blue-400 -px-2 dark:text-blue-400 "
        >
          {link == "Events" ? (
            <svg
              xmlns="http://www.w3.org/2000/svg"
